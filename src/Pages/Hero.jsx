      ...
      <LazyMotion features={domAnimation} strict>
        ...
        >
          ...
          <m.div
            ...
            className="absolute w-full max-w-3xl px-4 flex flex-col items-center gap-6 z-20 md:top-[45%] sm:top-[35%] top-[30%]"
             // adjust this to move the entire block up/down visually
            >
          {/* Sample Prompts Grid */}
          <m.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 1 }}
            className="w-full max-w-3xl px-4 grid grid-cols-1 md:grid-cols-2 gap-3"
          >
            {[
